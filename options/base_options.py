...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--train_root', type=str, help='输入训练路径, 会覆盖dataroot里默认的训练路径')
        parser.add_argument('--test_root', type=str, help='输入测试路径, 会覆盖dataroot里默认的测试路径')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='unaligned', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization | he2ihc]') #加上了he2ihc
        ...
        parser.add_argument('--load_size', type=int, default=554, help='scale images to this size')
        parser.add_argument('--crop_size', type=int, default=512, help='then crop to this size')
        parser.add_argument('--max_dataset_size', type=int, default=float("inf"), help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
        parser.add_argument('--preprocess', type=str, default='resize_and_crop', help='scaling and cropping of images at load time [resize_and_crop | resize | crop | scale_width | scale_width_and_crop | none]')
