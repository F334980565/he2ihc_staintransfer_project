...
class HE2IHCTESTDataset(BaseDataset):
    def __init__(self, opt):
        ...
        for slice_name in self.slice_list:
            he_file_list = os.listdir(os.path.join(opt.src_path, slice_name))
            slice_he_paths = [os.path.join(opt.src_path, slice_name, filename) for filename in he_file_list]
